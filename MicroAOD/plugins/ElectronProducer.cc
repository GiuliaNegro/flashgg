...
namespace flashgg {
	...
	private:
		...
		edm::EDGetTokenT<edm::ValueMap<unsigned int> > heepValuesMapToken_; 
	...
	ElectronProducer::ElectronProducer( const ParameterSet &iConfig ):
		...
		heepValuesMapToken_(consumes<edm::ValueMap<unsigned int> >(iConfig.getParameter<edm::InputTag>("heepValuesMap"))),
